package English::ListenNumbers::Web;
use strict;
use warnings;
use utf8;
use parent qw/English::ListenNumbers Amon2::Web/;
use File::Spec;

# dispatcher
use English::ListenNumbers::Web::Dispatcher;
sub dispatch {
    return English::ListenNumbers::Web::Dispatcher->dispatch($_[0]) or die "response is not generated";
}
